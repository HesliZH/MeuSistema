...
// Create page object
$controle_combustiveis_edit = new controle_combustiveis_edit();

// Run the page
$controle_combustiveis_edit->run();
...
$controle_combustiveis_edit->Page_Render();
?>
...
var fcontrole_combustiveisedit = currentForm = new ew.Form("fcontrole_combustiveisedit", "edit");

// Validate form
fcontrole_combustiveisedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($controle_combustiveis_edit->id_veiculo->Required) { ?>
		...
		<?php } ?>
		<?php if ($controle_combustiveis_edit->data_abastecimento->Required) { ?>
		...
		<?php if ($controle_combustiveis_edit->id_conta->Required) { ?>
		...
		<?php } ?>
		<?php if ($controle_combustiveis_edit->valor->Required) { ?>
...
fcontrole_combustiveisedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fcontrole_combustiveisedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcontrole_combustiveisedit.lists["x_id_veiculo"] = <?php echo $controle_combustiveis_edit->id_veiculo->Lookup->toClientList() ?>;
fcontrole_combustiveisedit.lists["x_id_veiculo"].options = <?php echo JsonEncode($controle_combustiveis_edit->id_veiculo->lookupOptions()) ?>;
fcontrole_combustiveisedit.lists["x_id_conta"] = <?php echo $controle_combustiveis_edit->id_conta->Lookup->toClientList() ?>;
fcontrole_combustiveisedit.lists["x_id_conta"].options = <?php echo JsonEncode($controle_combustiveis_edit->id_conta->lookupOptions()) ?>;
...
<?php $controle_combustiveis_edit->showPageHeader(); ?>
<?php
$controle_combustiveis_edit->showMessage();
?>
<form name="fcontrole_combustiveisedit" id="fcontrole_combustiveisedit" class="<?php echo $controle_combustiveis_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($controle_combustiveis_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $controle_combustiveis_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="controle_combustiveis">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$controle_combustiveis_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($controle_combustiveis->id_veiculo->Visible) { // id_veiculo ?>
	<div id="r_id_veiculo" class="form-group row">
		<label id="elh_controle_combustiveis_id_veiculo" for="x_id_veiculo" class="<?php echo $controle_combustiveis_edit->LeftColumnClass ?>"><?php echo $controle_combustiveis->id_veiculo->caption() ?><?php echo ($controle_combustiveis->id_veiculo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $controle_combustiveis_edit->RightColumnClass ?>"><div<?php echo $controle_combustiveis->id_veiculo->cellAttributes() ?>>
...
<?php if ($controle_combustiveis->data_abastecimento->Visible) { // data_abastecimento ?>
	<div id="r_data_abastecimento" class="form-group row">
		<label id="elh_controle_combustiveis_data_abastecimento" for="x_data_abastecimento" class="<?php echo $controle_combustiveis_edit->LeftColumnClass ?>"><?php echo $controle_combustiveis->data_abastecimento->caption() ?><?php echo ($controle_combustiveis->data_abastecimento->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $controle_combustiveis_edit->RightColumnClass ?>"><div<?php echo $controle_combustiveis->data_abastecimento->cellAttributes() ?>>
...
<?php if ($controle_combustiveis->id_conta->Visible) { // id_conta ?>
	<div id="r_id_conta" class="form-group row">
		<label id="elh_controle_combustiveis_id_conta" for="x_id_conta" class="<?php echo $controle_combustiveis_edit->LeftColumnClass ?>"><?php echo $controle_combustiveis->id_conta->caption() ?><?php echo ($controle_combustiveis->id_conta->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $controle_combustiveis_edit->RightColumnClass ?>"><div<?php echo $controle_combustiveis->id_conta->cellAttributes() ?>>
...
<?php if ($controle_combustiveis->valor->Visible) { // valor ?>
	<div id="r_valor" class="form-group row">
		<label id="elh_controle_combustiveis_valor" for="x_valor" class="<?php echo $controle_combustiveis_edit->LeftColumnClass ?>"><?php echo $controle_combustiveis->valor->caption() ?><?php echo ($controle_combustiveis->valor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $controle_combustiveis_edit->RightColumnClass ?>"><div<?php echo $controle_combustiveis->valor->cellAttributes() ?>>
...
<?php } ?>
	...
	<input type="hidden" data-table="controle_combustiveis" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($controle_combustiveis->id->CurrentValue) ?>">
<?php if (!$controle_combustiveis_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $controle_combustiveis_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $controle_combustiveis_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$controle_combustiveis_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$controle_combustiveis_edit->terminate();
?>