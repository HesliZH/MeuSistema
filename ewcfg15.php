...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "MeuSistema"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'nvLjkne7AW6RXm1i'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/MeuSistema.css"); // Project stylesheet file name
...
$PROJECT_ID = "{628FD02F-7671-473B-A63D-794D47F89F71}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "POSTGRESQL", "host" => "localhost", "port" => 5432, "user" => "postgres", "pass" => "postgres", "db" => "meu_sistema", "schema" => "", "qs" => "\"", "qe" => "\"");
...
define(PROJECT_NAMESPACE . "ADMIN_USER_NAME", "HesliZH"); // Administrator user name
define(PROJECT_NAMESPACE . "ADMIN_PASSWORD", "y43y45ha8876"); // Administrator password
