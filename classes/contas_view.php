 ...
 * Page class
 */
class contas_view extends contas
{
	...
	// Page object name
	public $PageObjName = "contas_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "contaslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "contaslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "contaslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
