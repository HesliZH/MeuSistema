...
class index
{
	...
	public function run()
	{
		...
		if (!$Security->isLoggedIn())
			$Security->autoLogin();
		if ($Security->isLoggedIn())
			$this->terminate("contaslist.php"); // Exit and go to default page
		if ($Security->isLoggedIn())
			$this->terminate("veiculoslist.php");
		if ($Security->isLoggedIn())
			$this->terminate("controle_combustiveislist.php");
		if ($Security->isLoggedIn())
			$this->terminate("contas_pagarlist.php");
		if ($Security->isLoggedIn()) {
