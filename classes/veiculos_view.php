 ...
 * Page class
 */
class veiculos_view extends veiculos
{
	...
	// Page object name
	public $PageObjName = "veiculos_view";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("veiculoslist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "veiculoslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "veiculoslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "veiculoslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("veiculoslist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
